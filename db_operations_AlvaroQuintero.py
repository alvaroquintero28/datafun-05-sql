...
Purpose of this project is to get acquainted with sqlite and how to master it by the time everything is completed. 
'''
...
db_file = "C:\\Users\\Alvaro Quintero\\Documents\\datafun-05-sql\\project.db"
...
def insert_records():
    ...
    try:
        with sqlite3.connect(db_file) as conn:
            sql_file = "C:\\Users\\Alvaro Quintero\\Documents\\datafun-05-sql\\insert_records.sql"
